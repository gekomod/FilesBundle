...
use Gekomod\FilesBundle\Event\FileManagerEvents;
use Gekomod\FilesBundle\Helpers\File;
use Gekomod\FilesBundle\Helpers\FileManager;
use Gekomod\FilesBundle\Helpers\UploadHandler;
use Gekomod\FilesBundle\Twig\OrderExtension;
...
class ManagerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('@Files/manager.html.twig', $parameters);
    }
    ...
    private function getBasePath($queryParameters)
    {
        ...
        $managerConf = $this->getParameter('gekomod_files')['conf'];
    ...
    private function newFileManager($queryParameters)
    {
        ...
        $webDir = $this->getParameter('gekomod_files')['web_dir'];
